import {TouchableOpacity,TouchableWithoutFeedback,StyleSheet,ImageBackground} from 'react-native';
...
export default class UsertPage extends  React.Component{
    state = { 
        color : '#136DF3',
            ...
            <View style={styles.container}>
                <View style={styles.containerone}>
                    ...
                    <View style={styles.boxtwo}>
                        <Text style={styles.name}>Hi, Natia</Text>
                        <Text style={styles.subtitle}>Here is your goal</Text>
                    </View>
